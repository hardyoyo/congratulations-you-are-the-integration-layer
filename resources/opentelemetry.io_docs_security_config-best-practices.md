...
* English
  EN
  + [বাংলা (Bengali)](/bn/docs/security/config-best-practices/)
  + English
  + [Español](/es/docs/security/config-best-practices/)
  + [Français](/fr/docs/security/config-best-practices/)
  + [日本語 (Japanese)](/ja/docs/security/config-best-practices/)
  + [Polski (Polish)](/pl/docs/security/config-best-practices/)
  + [Português](/pt/docs/security/config-best-practices/)
  + [Română (Romanian)](/ro/docs/security/config-best-practices/)
  + [Українська (Ukrainian)](/uk/docs/security/config-best-practices/)
  + [中文 (Chinese)](/zh/docs/security/config-best-practices/)
* + Light
  + Dark
  + Auto
...
[View page source](https://github.com/open-telemetry/opentelemetry.io/tree/main/content/en/docs/security/config-best-practices.md)
 [Edit this page](https://github.com/open-telemetry/opentelemetry.io/edit/main/content/en/docs/security/config-best-practices.md)
 [Create child page](https://github.com/open-telemetry/opentelemetry.io/new/main/content/en/docs/security?filename=change-me.md&value=---%0Atitle%3A+%22Long+Page+Title%22%0AlinkTitle%3A+%22Short+Nav+Title%22%0Aweight%3A+100%0Adescription%3A+%3E-%0A+++++Page+description+for+heading+and+indexes.%0A---%0A%0A%23%23+Heading%0A%0AEdit+this+template+to+create+your+new+page.%0A%0A%2A+Give+it+a+good+name%2C+ending+in+%60.md%60+-+e.g.+%60get-started.md%60%0A%2A+Edit+the+%22front+matter%22+section+at+the+top+of+the+page+%28weight+controls+how+its+ordered+amongst+other+pages+in+the+same+directory%3B+lowest+number+first%29.%0A%2A+Add+a+good+commit+message+at+the+bottom+of+the+page+%28%3C80+characters%3B+use+the+extended+description+field+for+more+detail%29.%0A%2A+Create+a+new+branch+so+you+can+preview+your+new+file+and+request+a+review+via+Pull+Request.%0A)
 [Create documentation issue](https://github.com/open-telemetry/opentelemetry.io/issues/new?title=Collector%20configuration%20best%20practices)

On this page

* [Create secure configurations](#create-secure-configurations)
  + [Store your configuration securely](#store-your-configuration-securely)
  + [Use encryption and authentication](#use-encryption-and-authentication)
  + [Minimize the number of components](#minimize-the-number-of-components)
  + [Configure with care](#configure-with-care)
* [Set permissions carefully](#set-permissions-carefully)
  + [Observers](#observers)
* [Manage specific security risks](#manage-specific-security-risks)
  + [Protect against denial of service attacks](#protect-against-denial-of-service-attacks)
    - [Docker](#docker)
    - [Docker Compose](#docker-compose)
    - [Kubernetes](#kubernetes)
  + [Scrub sensitive data](#scrub-sensitive-data)
  + [Safeguard resource utilization](#safeguard-resource-utilization)
...
```
docker run --hostname my-hostname --name container-name -p 127.0.0.1:4567:4317 otel/opentelemetry-collector:0.147.0
```
